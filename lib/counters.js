...
const fs = require("fs");
const ttlCounterScript = fs.readFileSync(
  __dirname + "/lua/ttlcounter.lua",
  "utf-8"
);
const cachedCounterScript = fs.readFileSync(
  __dirname + "/lua/cachedcounter.lua",
  "utf-8"
);
const limitedCounterScript = fs.readFileSync(
  __dirname + "/lua/limitedcounter.lua",
  "utf-8"
);
